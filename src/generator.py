...
def _get_generation_user_prompt(topic: str, level: str, lang: str) -> str:
    if lang == "en":
        base = (
            f"Topic: {topic}\n"
            f"Level: {level}\n"
...
def generate_microlearning_path(topic: str, level: str, context_modules: list | None = None, lang: str = "it") -> TutorResponse:
    user_prompt = _get_generation_user_prompt(topic, level, lang)
